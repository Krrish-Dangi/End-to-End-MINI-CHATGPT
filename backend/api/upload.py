...
def upload_file(session_id: str = Form(...), file: UploadFile = File(...)): ## Why Form(...) and File(...) bcz fastapi do not accepts json and file in same req. Form(...) does not works on pydantic models
